...
#### Build the deep learning models with 2 hidden layers (one layer: GRU, three layer: fc3, fc35, and fc4) ###
...
model_pkl = 'rnn-gru4-%d' % sequence_length
...
model_pkl = 'birnn-gru4-%d' % sequence_length
torch.save(rnn.state_dict(), '%s.pkl'%model_pkl)
